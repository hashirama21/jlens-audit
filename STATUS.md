...
| config.py JUDGE_A/JUDGE_B, GENERATOR | ✅ set | Anthropic/OpenAI judges (IDs verified on OpenRouter); 3rd-family generator `gemini-2.5-flash` (Pro's reasoning budget truncated the JSON); env-overridable |
